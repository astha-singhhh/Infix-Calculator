...
InfixCalculator has a main method for running the program and all the various methods that make up an infix calculator. 
The files DoubleNode, MyDoublyLinkedList, MyQueue, DoublyLinkedList, and Queue are classes and interfaces that create a doubly linked list queue implementation. 
